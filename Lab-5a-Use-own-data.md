...
1. In a new browser tab, download the [zipped archive of brochures](https://github.com/parveenkrraina/AIFoundry/raw/refs/heads/main/data/brochures.zip) from `https://github.com/parveenkrraina/AIFoundry/raw/refs/heads/main/data/brochures.zip` and extract it to a folder named **brochures** on your local file system.
...
1. After the repo has been cloned, navigate to the folder containing the chat application code files:
    ...
    ```
   cd aifoundry/samples/rag-app/python
    ```
